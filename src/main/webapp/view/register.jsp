...
<div class="middle-box text-center loginscreen   animated fadeInDown">
    <div>
        ...
        <h3>欢迎注册 H+</h3>
        <p>创建一个H+新账户</p>
        <form id="form1" class="m-t" role="form" action="/userRegister">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="请输入用户名" name="uname" required="">
            </div>
            <div class="form-group">
                <input type="password" class="form-control" placeholder="请输入密码" name="upassword" required="">
            </div>
            <div class="form-group">
                <input type="password" class="form-control" placeholder="请再次输入密码" name="upassword1" required="">
            </div>
